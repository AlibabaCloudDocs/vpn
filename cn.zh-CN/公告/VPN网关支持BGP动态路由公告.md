...
**说明：** 目前VPN网关BGP动态路由功能白名单开放。如需使用，请[提交工单](https://selfservice.console.aliyun.com/ticket/category/vpn/today)。
...
具体操作，请参见[建立VPC到本地数据中心的连接（BGP动态路由）](/cn.zh-CN/IPsec-VPN入门/建立VPC到本地数据中心的连接（BGP动态路由）.md)。
